 ...
 late String token;
  ...
  Future updateCategory(Category category) async {
    ...
    if (response.statusCode != 200) {
      throw Exception('Error happened on cat update');
    }
  ...
  Future<void> deleteCategory(id) async {
    ...
    if (response.statusCode != 204) {
      throw Exception('Error happened on cat delete');
    }
  }
  ...
  Future<Category> addCategory(String name) async {
    ...
    if (response.statusCode != 201) {
      throw Exception('Error happened on cat Create');
    }
    return Category.fromJson(jsonDecode(response.body));
  }
  ...
  Future<void> logout() async {
    String uri = baseUrl + 'auth/logout';
    ...
    if (response.statusCode != 204) {
      throw Exception('Error happened on logout api');
    }
  }
}
